...
pub const BG_BASE: Color = Color { r: 0.102, g: 0.118, b: 0.137, a: 1.0 }; // #1a1e23
pub const BG_SURFACE: Color = Color { r: 0.067, g: 0.078, b: 0.094, a: 1.0 }; // #111418
pub const BG_CARD: Color = Color { r: 0.110, g: 0.129, b: 0.157, a: 1.0 }; // #1c2128
pub const BG_HOVER: Color = Color { r: 0.129, g: 0.149, b: 0.176, a: 1.0 }; // #21262d

pub const BORDER_SUBTLE: Color = Color { r: 0.180, g: 0.200, b: 0.220, a: 1.0 }; // #2e3338
pub const BORDER_DEFAULT: Color = Color { r: 0.267, g: 0.298, b: 0.337, a: 1.0 }; // #444c56

pub const TEXT_PRIMARY: Color = Color { r: 0.788, g: 0.820, b: 0.851, a: 1.0 }; // #c9d1d9
pub const TEXT_SECONDARY: Color = Color { r: 0.545, g: 0.580, b: 0.620, a: 1.0 }; // #8b949e
pub const TEXT_MUTED: Color = Color { r: 0.416, g: 0.463, b: 0.506, a: 1.0 }; // #6e7681

pub const ACCENT: Color = Color { r: 0.000, g: 0.510, b: 0.788, a: 1.0 }; // #0082C9

pub const STATUS_OK: Color = Color { r: 0.247, g: 0.725, b: 0.314, a: 1.0 }; // #3fb950
pub const STATUS_SYNCING: Color = Color { r: 0.345, g: 0.643, b: 0.831, a: 1.0 }; // #58a6d4
pub const STATUS_ERROR: Color = Color { r: 0.973, g: 0.318, b: 0.286, a: 1.0 }; // #f85149
pub const STATUS_PAUSED: Color = Color { r: 0.824, g: 0.600, b: 0.133, a: 1.0 }; // #d29922
...
pub fn primary_button_style(_theme: &iced::Theme, status: button::Status) -> button::Style {
    let bg = match status {
        ...
        button::Status::Hovered => Color { r: ACCENT.r + 0.05, g: ACCENT.g + 0.04, b: ACCENT.b + 0.04, a: 1.0 },
        button::Status::Pressed => Color { r: ACCENT.r * 0.85, g: ACCENT.g * 0.85, b: ACCENT.b * 0.85, a: 1.0 },
        button::Status::Disabled => BG_CARD,
    };
    let text_color = if matches!(status, button::Status::Disabled) { TEXT_MUTED } else { Color::WHITE };
    button::Style {
...
pub fn danger_button_style(_theme: &iced::Theme, status: button::Status) -> button::Style {
    let (bg, text_color, border_color) = match status {
        button::Status::Active => (
            Color { r: 0.243, g: 0.082, b: 0.078, a: 1.0 },
            STATUS_ERROR,
            STATUS_ERROR,
        ),
        button::Status::Hovered => (
            Color { r: 0.350, g: 0.110, b: 0.104, a: 1.0 },
            Color::WHITE,
            STATUS_ERROR,
        ),
        button::Status::Pressed => (
            Color { r: 0.180, g: 0.055, b: 0.053, a: 1.0 },
            Color::WHITE,
            STATUS_ERROR,
        ),
...
pub fn text_input_style(_theme: &iced::Theme, status: text_input::Status) -> text_input::Style {
    match status {
        text_input::Status::Active => text_input::Style {
            ...
            border: Border { color: BORDER_DEFAULT, width: 1.0, radius: 6.0.into() },
            icon: TEXT_SECONDARY,
        ...
        text_input::Status::Focused => text_input::Style {
            background: Background::Color(BG_CARD),
            border: Border { color: ACCENT, width: 1.5, radius: 6.0.into() },
            icon: ACCENT,
            placeholder: TEXT_MUTED,
            value: TEXT_PRIMARY,
            selection: Color { a: 0.3, ..ACCENT },
        ...
        text_input::Status::Disabled => text_input::Style {
            ...
            placeholder: TEXT_MUTED,
            value: TEXT_MUTED,
            selection: Color { r: 0.0, g: 0.0, b: 0.0, a: 0.0 },
        },
    }
}
